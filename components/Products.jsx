...
const Products = () => {
    const filteredArray = products.slice(0, 4);
  return (
    <div
      id="products"
      className="bg-red-50 flex w-full flex-col items-stretch  pt-20 pb-12 px-20 max-md:max-w-full max-md:mt-10 max-md:px-5"
    >
      ...
      <div className="my-20 w-full  flex justify-center items-center gap-5 flex-wrap lg:flex-nowrap">
        {filteredArray.map((product, ind) => (
          <div
      ...
      <div className="flex justify-end items-center">
        <Link href={'/products'}  className="text-white text-md font-medium leading-normal bg-orange-700 justify-center mt-8 px-6 py-2 rounded-[6px] ">View More</Link>
      </div>
    </div>
  );
};
